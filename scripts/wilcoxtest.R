...
library("tibble")
library("qvalue")
wilcoxtest_summary <- function(OTU_input, group_index, index_pvalue, group1, group2, plot_method, alpha){
...
text_wilcoxtest_summary<- paste("Total of ", nrow(res_tax_sig), " taxa were identified as significant.", sep="")
 ...
 return(list(wilcoxtest_result_summary=text_wilcoxtest_summary, wilcoxtest_result_significant=res_tax_sig, wilcoxtest_result_table=res_tax, wilcoxtest_relative_frequency=rel_freq, total_counts=parent_seq_count))
 }
}