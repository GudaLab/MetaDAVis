...
library("qvalue")
library("dunn.test")
kruskal_wallis_test_summary <- function(OTU_input, group_index, index_pvalue, ad_hoc, plot_method, alpha){
...
return(list(kruskal_wallis_test_result_summary=text_kruskal_wallis_test_summary, kruskal_wallis_test_result_significant=res_tax_sig, kruskal_wallis_test_result_table=res_tax, kruskal_wallis_test_relative_frequency=rel_freq, total_counts=parent_seq_count))
