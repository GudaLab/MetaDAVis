...
ttest_summary <- function(OTU_input, group_index, index_pvalue, group1, group2, plot_method, alpha){
...
return(list(ttest_result_summary=text_ttest_summary, ttest_result_significant=res_tax_sig, ttest_result_table=res_tax, ttest_relative_frequency=rel_freq, total_counts=parent_seq_count))
}
}
